  ...
  internal class QRCodeFinder
  {
    ...
    public override string ToString()
    {
      return Distance == double.MaxValue ? 
        string.Format("Finder: Row: {0}, Col1: {1}, Col2: {2}, HModule: {3:0.00}", Row, Col1, Col2, HModule) : 
        string.Format("Finder: Row: {0}, Col: {1}, Module: {2:0.00}, Distance: {3:0.00}", Row, Col, ModuleSize, Distance);
    }
  }
}
